...
# Since the cwd has been changed in the load_dir/load_file function, we don't need the full path to find the song.

def rename_prompt(song_file): 
    ...
    if rename:
        ...
        return None             # Returning None so whoever called this can handle it
